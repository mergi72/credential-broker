...
OutputBaseFilename=CredentialBrokerSetup-v0.2.0-alpha
Compression=lzma
...
[Run]
Filename: "powershell.exe"; Parameters: "-NoProfile -ExecutionPolicy Bypass -File ""{app}\install-broker.ps1"" -InstallRoot ""{app}"" -ExePath ""{app}\credential-broker.exe"" -ConfigSourceDir ""{app}\config"" -TaskName ""CredentialBroker"" -StartImmediately"; Flags: waituntilterminated logoutput
