...
OutputBaseFilename=CredentialBrokerSetup-v0.5.0-beta
Compression=lzma
...
[Run]
Filename: "powershell.exe"; Parameters: "-NoProfile -ExecutionPolicy Bypass -File ""{app}\install-broker.ps1"""; Flags: waituntilterminated
